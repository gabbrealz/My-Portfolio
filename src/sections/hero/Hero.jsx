...
export default function Hero() {
  return (
    <section id="hero" className="w-1/2 md:w-2/3 h-[70vh] md:h-screen">
      ...
      <div className="w-full h-full flex justify-center items-center">
        <div className="pl-6 w-9/10 md:4/5 z-2 flex flex-col justify-center">
          ...
          <span className="mt-2 text-sm sm:text-md md:text-xl lg:text-2xl">
            A tech student and aspiring developer!
          </span>
          <div className="mt-4 w-fit flex gap-2 sm:gap-3 md:gap-4">
