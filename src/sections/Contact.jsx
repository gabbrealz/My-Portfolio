...
export default function Contact({ ref }) {
  return (
    <section ref={ref} className="animate-entry-opacity mx-auto min-h-[40vh] mb-[5vh] sm:mb-[10vh] md:mb-[15vh] lg:mb-[20vh] xl:mb-[25vh]">
      <h1 className="mb-4 sm:mb-6 md:mb-8">
        <span className="block mb-1 text-center text-highlight-1 text-sm sm:text-base md:text-lg md:mb-2 lg:text-xl">
          GOT AN IDEA? LET'S
        </span>
      ...
      <div className="flex flex-col justify-center items-center gap-8 sm:gap-10 md:gap-12">
        <p className="w-3/5 font-body text-center text-shadow-md text-shadow-black text-xs sm:w-1/2 sm:text-sm md:text-base lg:text-lg">
        ...
        " href="mailto:christianagot11@gmail.com">
          ...
          <span className="z-10 group-hover:text-black transition-colors duration-150 select-none text-sm mr-2 sm:mr-3 sm:text-base md:text-lg">
            Say Hello
          </span>
